...
public class QuestionListAdapter2 extends RecyclerView.Adapter<QuestionListAdapter2.HeroViewHolder> {
    private Context mCtx;
    private List<GetQuestionModel> heroList;

    public static ArrayList<String> selectedAnswers2 = new ArrayList<>();


    public QuestionListAdapter2(Context mCtx, List<GetQuestionModel> heroList) {
        this.mCtx = mCtx;
        this.heroList = heroList;
        for (int i = 0; i < heroList.size(); i++) {
            selectedAnswers2.add("Not Attempted");
        }
    }
        ...
        holder.mradio_one.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    if (!hero.getOptionA().equals("")){
                      selectedAnswers2.set(position,"\"" + hero.getId().trim() + "\""+":"+"\"" + "A" + "\"");
                    }else {
                        selectedAnswers2.set(position,"\"" + hero.getId().trim() + "\""+":"+"\"" + "A" + "\""); }
                } else {
        ...
        holder.mradio_two.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    if (!hero.getOptionB().equals("")){
                        selectedAnswers2.set(position,"\"" + hero.getId().trim() + "\""+":"+"\"" + "B" + "\"");
                    }else {
                        selectedAnswers2.set(position,"\"" + hero.getId().trim() + "\""+":"+"\"" + "B" + "\"");
                    }
                } else {
        ...
        holder.mradio_three.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    if (!hero.getOptionC().equals("")){
                        selectedAnswers2.set(position,"\"" + hero.getId().trim() + "\""+":"+"\"" + "C" + "\"");
                    }else {
                        selectedAnswers2.set(position,"\"" + hero.getId().trim() + "\""+":"+"\"" + "C" + "\"");
                    }
                } else {
        ...
        holder.mradio_four.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    if (!hero.getOptionD().equals("")){
                        selectedAnswers2.set(position,"\"" + hero.getId().trim() + "\""+":"+"\"" + "D" + "\"");
                    }else {
                        selectedAnswers2.set(position,"\"" + hero.getId().trim() + "\""+":"+"\"" + "D" + "\"");
                    }
                } else {
