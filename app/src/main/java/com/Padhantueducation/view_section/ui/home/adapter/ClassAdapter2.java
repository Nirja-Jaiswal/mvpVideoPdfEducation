...
public class ClassAdapter2 extends RecyclerView.Adapter<ClassAdapter2.HeroViewHolder> {

    Context mCtx;
    List<GetClass> heroList;

    public ClassAdapter2(Context mCtx, List<GetClass> heroList) {
        this.mCtx = mCtx;
        ...
        holder.linear_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mCtx.startActivity(new Intent(mCtx, SubjectActivity.class)
                        .putExtra("cource_id",heroList.get(position).getCourse_id()));
            }
        });
